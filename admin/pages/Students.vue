    ...
    <v-main class="cyan lighten-5">
     ...
     <v-container class="cyan lighten-5">
      ...
      <v-toolbar flat color="cyan lighten-3">
        <v-toolbar-title class="text-h4">Student Database</v-toolbar-title>
        <v-divider
          class="mx-2"
          inset
          vertical
            ...
            <v-card-text color="cyan darken-3" >
              <v-container grid-list-md class="cyan darken-3">
                <v-layout wrap >
                  ...
                  <v-flex xs12 sm6 md4>
                    <v-text-field v-model="email" label="Email" color="black"></v-text-field>
                  </v-flex>
      ...
      <template #item.edit="{ item }">
       ...
       <v-icon
            ...
            <v-icon
              small
              color="error"
          @click="deleteItem(users[users.indexOf(item)]._id,item)"
            >
              Delete
            </v-icon>
            </v-btn>
